...
namespace FilesFullTrust
{
    internal class Program
    {
        ...
        private static ShellFileItem GetShellFileItem(ShellItem folderItem)
        {
            ...
            {
                return new ShellFileItem(isFolder, folderItem.FileSystemPath, Path.GetFileName(folderItem.Name), folderItem.Name, DateTime.UtcNow.ToFileTime(), DateTime.UtcNow.ToFileTime(), DateTime.UtcNow.ToFileTime(), null, 0, null);
            }
