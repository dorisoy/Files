...
namespace FilesFullTrust
{
    internal class Program
    {
        ...
        private static ShellFileItem GetRecycleBinItem(ShellItem folderItem)
        {
            ...
            {
                return new ShellFileItem(isFolder, recyclePath, fileName, filePath, DateTime.UtcNow.ToFileTime(), DateTime.UtcNow.ToFileTime(), DateTime.MinValue.ToFileTime(), null, 0, null);
            }
            ...
            return new ShellFileItem(isFolder, recyclePath, fileName, filePath, recycleDate, modifiedDate, DateTime.MinValue.ToFileTime(), fileSize, fileSizeBytes ?? 0, fileType);
        }
